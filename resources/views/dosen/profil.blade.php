                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                            <div class="modal-content">
                                ...
                                <div class="modal-body p-4">
                                    <form action="{{ url('dosen/profil/update-foto') }}" method="POST"
                    ...
                    <div id="dataModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                            <div class="modal-content">
                                ...
                                <div class="modal-body p-4">
                                    <form action="{{ url('dosen/profil/update-data') }}" method="POST"
                                        enctype="multipart/form-data">
                                        @method('PUT')
                                        @csrf
                                        <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-10 col-lg-6">
                                        <form action="{{ url('dosen/profil/ganti-password') }}" method="POST">
                                            @method('PUT')
                                            @csrf
