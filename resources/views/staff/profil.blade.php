...
<div class="content container-fluid">
   <div class="page-header">
      <div class="row">
         <div class="col">
            <h3 class="page-title">Profil User</h3>
            <ul class="breadcrumb">
               <li class="breadcrumb-item"><a href="{{ route('s-dashboard') }}">Dashboard</a></li>
   ...
   <div class="row">
      <div class="col-md-12">
         @if (session('success'))
         @include('user.components.alert-success', ['message' => session('success')])
         @endif
         @if ($errors->any())
         @include('user.components.alert-danger', ['errors' => $errors->all()])
         @endif
         <div class="profile-header">
            <div class="row align-items-center">
               <div class="col-auto profile-image">
                  <a href="#">
                     <img class="rounded-circle" alt="{{ $user->nama }}" src="{{ asset(" storage/$user->foto") }}">
                  </a>
               </div>
               <div class="col ms-md-n2 profile-user-info">
                  <h4 class="user-name mb-0">{{ $user->nama }}</h4>
               ...
               <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                  <div class="modal-content">
                     ...
                     <div class="modal-body p-4">
                        <form action="{{ url('user/profil/update-foto') }}" method="POST" enctype="multipart/form-data">
                           @method('PUT')
                           @csrf
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="mb-3">
                                    ...
                                    <input type="file" name="foto" @error('foto') is-invalid @enderror
                                       class="form-control" id="foto" placeholder="Unggah File" required
                                       accept=".png, .jpg, .jpeg">
                                    @error('foto')
                     ...
                     <div class="card">
                        <div class="card-body">
                           ...
                           <div class="row">
                              ...
                              <p class="col-sm-6">{{ $user->nama }}</p>
                           </div>
                           <div class="row">
                              <p class="col-sm-6 text-muted text-sm-end mb-0 mb-sm-3">Nomor Induk user
                              </p>
                              <p class="col-sm-6">{{ $user->nim }}</p>
                           </div>
                           <div class="row">
            ...
            <div id="dataModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
               ...
               <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                  <div class="modal-content">
                     ...
                     <div class="modal-body p-4">
                        <form action="{{ url('user/profil/update-data') }}" method="POST" enctype="multipart/form-data">
                           @method('PUT')
                           @csrf
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="mb-3">
                                    ...
                                    <input type="text" name="nama" @error('nama') is-invalid @enderror
                              ...
                              <div class="col-md-12">
                                 <div class="mb-3">
                                    ...
                                    <input type="text" name="nim" @error('nim') is-invalid @enderror
                                       class="form-control" id="nim" placeholder="Masukkan NIM"
                              ...
                              <div class="col-md-12">
                                 <div class="mb-3">
                                    ...
                                    <input type="text" name="username" @error('username') is-invalid @enderror
                                       class="form-control" id="username" placeholder="Masukkan username"
                              ...
                              <div class="col-md-12">
                                 <div class="mb-3">
                                    ...
                                    <input type="text" name="no_hp" @error('no_hp') is-invalid @enderror
                  ...
                  <div class="card-body">
                     ...
                     <div class="row">
                        <div class="col-md-10 col-lg-6">
                           <form action="{{ url('user/profil/ganti-password') }}" method="POST">
                              @method('PUT')
                              @csrf
