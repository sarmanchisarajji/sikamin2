    ...
    <div class="content container-fluid">
        ...
        <div class="row d-flex justify-content-evenly flex-wrap gap-1">
            @foreach ($dosens as $item)
                        ...
                        <div class="d-flex justify-content-evenly gap-2" style="border-radius: 6px; margin-top: -10px;">
                            <div style="width: 50%">
                                <a class=" btn btn-primary" href="" data-bs-toggle="modal" style="width: 100%"
                                    data-bs-target="#modalPembimbing{{ $item->id }}">Pembimbing
                                    <br>{{ $item->total_bimbingan }}</a>
                            </div>
                            <div style="width: 50%">
                                <a class=" btn btn-danger" href="" data-bs-toggle="modal" style="width: 100%"
                                    data-bs-target="#modalPenguji{{ $item->id }}">Penguji
                                    <br>{{ $item->total_pengujian }}</a>
                            </div>
                ...
                {{-- Modal Pembimbing --}}
                <div class="modal fade" id="modalPembimbing{{ $item->id }}" tabindex="-1"
                                    ...
                                    <table id="" class="display " style="width:100%">
                                        <thead class="student-thread">
                                            <tr class="text-center">
                                                <th style="background-color: #3d5ee1" class="text-white" class="col-1">No
                                                </th>
                                                <th style="background-color: #3d5ee1" class="text-white" class="col-3">Nama
                                                </th>
                                                <th style="background-color: #3d5ee1" class="text-white" class="col-8">
                                                    Judul</th>
                                                <th style="background-color: #3d5ee1" class="text-white" class="col-8">
                                                    Jabatan</th>
                                            </tr>
                ...
                {{-- Modal Penguji --}}
                <div class="modal fade" id="modalPenguji{{ $item->id }}" tabindex="-1"
                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <div class="table-responsive">
                                    <table id="" class="display " style="width:100%">
                                        <thead class="student-thread">
                                            <tr class="text-center">
                                                <th style="background-color: #3d5ee1" class="text-white" class="col-1">
                                                    No</th>
                                                <th style="background-color: #3d5ee1" class="text-white" class="col-3">
                                                    Nama</th>
                                                <th style="background-color: #3d5ee1" class="text-white" class="col-8">
                                                    Judul</th>
                                                <th style="background-color: #3d5ee1" class="text-white" class="col-8">
