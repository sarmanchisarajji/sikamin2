         ...
         <div class="col-sm-12">
            <div class="page-sub-header">
               ...
               <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Surat Keterangan Ujian</li>
               </ul>
            </div>
         </div>
      </div>
   ...
   <div class="row">
      <div class="col-11 mx-auto">
         <ul class="d-flex justify-content-center gap-5 align-items-center py-3">
            ...
            <li>
               <a href="" class="file-link px-3 py-3"
                  style="display: inline-block; width: 100%; color: white; background-color: #3d5ee1">Surat Keterangan Ujian</a>
            </li>
            <li>
               <a href="" class="file-link px-3 py-3"
