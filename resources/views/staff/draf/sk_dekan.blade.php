        ...
        <div class="d-md-flex justify-content-evenly">
            <div class="col-md-4 col-12">
                <div class="bg-white px-4 py-4">
                    <form action="{{ route('s-sk_dekan_update', $ujian->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            <label class="custum-file-upload" for="file">
                                ...
                                <div class="text" id="filename">
                                    <span>
                                        {{ !empty($ujian->sk_dekan) ? basename($ujian->sk_dekan) : 'Tekan untuk upload file' }}
                                    </span>
                                </div>
                                <input type="file" id="file" name="sk_dekan" onchange="displayFileName()">
                            </label>
                        </div>
                        <div class="mt-4">
