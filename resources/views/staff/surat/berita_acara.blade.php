...
<body>
   ...
   <main>
      ...
      <table style="width: 100%; border-collapse: collapse; border: 1px solid black; margin-top: 10px">
         ...
         <tr>
            <td style="border-right: 1px solid black; padding: 8px 8px 30px 8px; text-align: center; height: 50px">5.</td>
            <td style="border-right: 1px solid black; padding: 8px 8px 30px 8px;">{{ $ujian->penguji_3->nama_dosen }}</td>
