        ...
        <table style="width: 100%">
                ...
                <td>
                    <table>
                        ...
                        <tr>
                            ...
                            <td style="text-align: justify">bahwa mahasiswa dalam lampiran surat keputusan ini telah
                                memenuhi
                                syarat untuk mengikuti Ujian Skripsi.</td>
                        </tr>
                        <tr>
                            <td style="vertical-align: top; padding-right: 8px">3.</td>
                            <td style="text-align: justify">untuk maksud tersebut perlu ditetapkan dengan Surat
                                Keputusan.</td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table>
                        <tr>
                            <td style="text-align: justify">KEPUTUSAN DEKAN FAKULTAS TEKNIK UNIVERSTAS HALU OLEO TENTANG
                                PENGANGKATAN DOSEN PENGUJI PADA UJIAN SKRIPSI MAHASISWA PROGRAM STUDI TEKNIK INFORMATIKA
                                FAKULTAS TEKNIK UHO;</td>
                        </tr>
                    </table>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <table>
                        <tr>
                            <td style="text-align: justify">Mengangkat Dosen Penguji pada Ujian Skripsi mahasiswa
                                Fakultas
                                Teknik
                ...
                <td style="width: 60%">
                    <table>
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: top; padding: 0 8px 0 8px">:</td>
                            <td style="text-align: justify">PENGANGKATAN DOSEN PENGUJI PADA UJIAN SKRIPSI MAHASISWA
    ...
    <main>
        <table style="width: 100%; border-collapse: collapse; margin-top: 10px">
            ...
            <tr style="text-align: left;">
                ...
                <td style="width: 35%; border: 0.5px solid black; padding: 8px;">{{ $ujian->penguji_1->nama_dosen }}
                </td>
                <td style="width: 35%; border: 0.5px solid black; padding: 8px;">
                    @if ($ujian->penguji_1->nip)
                        NIP. {{ $ujian->penguji_1->nip }}
                    @else
                        NIDN. {{ $ujian->penguji_1->nidn }}
                    @endif
                    <br>
                    {{ $ujian->penguji_1->pangkat }}
                </td>
            ...
            <tr style="text-align: left;">
                ...
                <td style="width: 35%; border: 0.5px solid black; padding: 8px;">{{ $ujian->penguji_2->nama_dosen }}
                </td>
                <td style="width: 35%; border: 0.5px solid black; padding: 8px;">
                    @if ($ujian->penguji_2->nip)
                        NIP. {{ $ujian->penguji_2->nip }}
                    @else
                        NIDN. {{ $ujian->penguji_2->nidn }}
                    @endif
                    <br>
                    {{ $ujian->penguji_2->pangkat }}
                </td>
            ...
            <tr style="text-align: left;">
                ...
                <td style="width: 35%; border: 0.5px solid black; padding: 8px;">{{ $ujian->penguji_3->nama_dosen }}
                </td>
                <td style="width: 35%; border: 0.5px solid black; padding: 8px;">
                    @if ($ujian->penguji_3->nip)
                        NIP. {{ $ujian->penguji_3->nip }}
                    @else
                        NIDN. {{ $ujian->penguji_3->nidn }}
                    @endif
                    <br>
                    {{ $ujian->penguji_3->pangkat }}
                </td>
                <td style="width: 25%; border: 0.5px solid black; padding: 8px; text-align: center">Anggota Penguji
                </td>
            </tr>
            <tr style="text-align: left;">
                ...
                <td style="width: 35%; border: 0.5px solid black; padding: 8px;">NIP. {{ $ujian->pembimbing_1->nip }}
                    <br>
            ...
            <tr style="text-align: left;">
                ...
                <td style="width: 35%; border: 0.5px solid black; padding: 8px;">
                    {{ $ujian->pembimbing_2->nama_dosen }}</td>
                <td style="width: 35%; border: 0.5px solid black; padding: 8px;">NIP. {{ $ujian->pembimbing_2->nip }}
                    <br>
