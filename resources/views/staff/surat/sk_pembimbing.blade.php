   ...
   <header style="margin-top: 30px">
      <table style="width: 100%">
         <tr style="text-align: center">
            ...
            <p style="padding-top: 5px">NOMOR : {!! $ujian->no_sk_pembimbing ? $ujian->no_sk_pembimbing : '
               /UN29.10/PP/2023' !!}</p>
      ...
      <table style="width: 100%">
         ...
         <tr>
            ...
            <td>
               <table>
                  <tr>
                     <td style="text-align: justify">Dosen pembimbing bertugas membimbing mahasiswa dalam penyusunan
