                                                ...
                                                <ul class="timeline">
                                                    @foreach ($item->ujian->where('jenis_ujian', 'skripsi') as $acc)
                                                        @if ($acc->status == 'selesai')
                                                            <li>
                                                                <a href="#"
                                                                    class="float-right">{{ \Carbon\Carbon::parse($acc->updated_at)->locale('id_ID')->isoFormat('dddd, D
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  MMMM YYYY') }}</a><br>
                                                    ...
                                                    @foreach ($item->ujian->where('jenis_ujian', 'skripsi') as $acc)
                                                        @if ($acc->tanggal_ujian)
                                                            <li>
                                                                <a href="#"
                                                                    class="float-right">{{ \Carbon\Carbon::parse($acc->tanggal_ujian)->locale('id_ID')->isoFormat('dddd, D
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  MMMM YYYY') }}</a><br>
                                                                <span class="h6" style="color: blue">Pelaksanaan
                                                                    Seminar Skripsi</span>
                                                                <div class="px-2 py-2"
                                                        ...
                                                        @if (($acc->status == 'disetujui') | ($acc->status == 'selesai'))
                                                            <li>
                                                                <a href="#"
                                                                    class="float-right">{{ \Carbon\Carbon::parse($acc->updated_at)->locale('id_ID')->isoFormat('dddd, D
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  MMMM YYYY') }}</a><br>
                                                                <span class="h6" style="color: green">Pengajuan
                                                                    Seminar Skripsi disetujui</span>
                                                                <div class="px-2 py-2"
                                                                    style="background-color: lightgreen; border: 1px solid green; border-radius: 3px">
                                                                    <div>
                                                                        <span
                                                                            style="text-transform: uppercase">{{ $acc->judul }}</span>
                                                                    </div>
                                                                    <div>
                                                                        <span>Pembimbing :
                                                                            {{ $acc->pembimbing_1->nama_dosen }},
                                                        ...
                                                        <li>
                                                            <a href="#"
                                                                class="float-right">{{ \Carbon\Carbon::parse($acc->created_at)->locale('id_ID')->isoFormat('dddd, D
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                MMMM YYYY') }}</a><br>
                                                    ...
                                                    @foreach ($item->ujian->where('jenis_ujian', 'proposal') as $acc)
                                                        ...
                                                        @if ($acc->status == 'disetujui')
                                                            <li>
                                                                ...
                                                                <span class="h6" style="color: green">Pengajuan
                                                                    Seminar
                                                                    {{ $acc->jenis_ujian == 'proposal' ? 'proposal' : 'hasil' }}
                                                                    disetujui</span>
                                                                <div class="px-2 py-2"
                                                                    style="background-color: lightgreen; border: 1px solid green; border-radius: 3px">
                                                                    <div>
                                                        ...
                                                        <li>
                                                            <a href="#"
                                                                class="float-right">{{ \Carbon\Carbon::parse($acc->created_at)->locale('id_ID')->isoFormat('dddd, D
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                MMMM YYYY') }}</a><br>
                                                            <span class="h6">Pengajuan Seminar
                                                                {{ $acc->jenis_ujian == 'proposal' ? 'proposal' : 'hasil' }}</span>
                                                            <p style="text-transform: uppercase">{{ $acc->judul }}</p>
                                                        </li>
                                                    @endforeach
                                                    ...
                                                    <li>
                                                        <a href="#"
                                                            class="float-right">{{ \Carbon\Carbon::parse($item->created_at)->locale('id_ID')->isoFormat('dddd, D
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              MMMM YYYY') }}</a><br>
        ...
        document.addEventListener('DOMContentLoaded', (event) => {
            ...
            const examChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                            label: 'Proposal',
                            data: @json(array_map('intval', array_values($monthlyProposalCounts))),
                        ...
                        {
                            label: 'Hasil',
                            data: @json(array_map('intval', array_values($monthlyHasilCounts))),
                        ...
                        {
                            label: 'Skripsi',
                            data: @json(array_map('intval', array_values($monthlySkripsiCounts))),
