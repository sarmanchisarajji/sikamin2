        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li
                    ...
                    <ul>
                        <li
                            style="background-color:  {{ $currentRoute == 's-m_ujian-index' || $currentRoute == 's-m_proposal-index' || $currentRoute == 's-m_hasil-index' || $currentRoute == 's-m_skripsi-index' ? '#3d5ee1' : '' }}; border-radius: 5px;">
                            <a href="{{ route('s-m_ujian-index') }}"
                                class="{{ $currentRoute == 's-m_ujian-index' || $currentRoute == 's-m_proposal-index' || $currentRoute == 's-m_hasil-index' || $currentRoute == 's-m_skripsi-index' ? 'text-white' : '' }}">Monitoring
                                Ujian</a>
                        </li>
                        <li
                            style="background-color:  {{ $currentRoute == 's-v_proposal-index' || $currentRoute == 's-v_hasil-index' || $currentRoute == 's-v_skripsi-index' ? '#3d5ee1' : '' }}; border-radius: 5px;">
                            <a href="{{ route('s-v_proposal-index') }}"
                                class="{{ $currentRoute == 's-v_proposal-index' || $currentRoute == 's-v_hasil-index' || $currentRoute == 's-v_skripsi-index' ? 'text-white' : '' }}">Verifikasi
                                Ujian</a>
                        </li>
                    </ul>
                </li>
